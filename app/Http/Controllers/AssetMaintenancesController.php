...
class AssetMaintenancesController extends Controller
{
    ...
    */
    public function getDatatable(Request $request)
    {
        ...
        foreach ($maintenances as $maintenance) {
            ...
            $rows[] = array(
                ...
                'admin_name'    =>  ($maintenance->admin) ? (string)link_to_route('maintenances.show', $maintenance->admin->present()->Name(), ['maintenance' => $maintenance->admin->id]) : 'Deleted Admin' ,
    ...
    public function create()
    {
        ...
        return view('asset_maintenances/edit')
                   ...
                   ->with('admin_list', Helper::adminList())
    ...
    */
    ...
    public function update(Request $request, $assetMaintenanceId = null)
    {
        ...
        // Save the asset maintenance data
        $assetMaintenance->asset_id               = $request->input('asset_id');
        $assetMaintenance->user_id                = $request->input('user_id');
        $assetMaintenance->asset_maintenance_type = $request->input('asset_maintenance_type');
        $assetMaintenance->title                  = $request->input('title');
        $assetMaintenance->start_date             = $request->input('start_date');
        $assetMaintenance->completion_date        = $request->input('completion_date');
